 <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
   ...
   $('body').on('click', '.show_company_detail', function () {
        ...
        var work_email = $(this).attr("data-work_email");
   ...
   $('#answers1').change(function(){
        ...
        var company_inc_exc = $('.company_inc_exc.active').attr('data-company_inc_exc');
        ...
        $.ajax({
            ...
            data: {
                ...
                filter_type:"job_company_name",
                name:"Company name",
                company_inc_exc: company_inc_exc
            },
            beforeSend: function() {
                $('.show_filter_company_list_msg').show();
            },
      ...
      let a = $(this).data('select2');
        ...
        $(".select2-results:not(:has(a))").append('<div class="include-btn"> <div class="btn-group" role="group" aria-label="Basic radio toggle button group"> <label class="btn btn-outline-primary active company_inc_exc" data-company_inc_exc="0" for="btnradio1">Include</label> <label class="btn btn-outline-primary company_inc_exc" data-company_inc_exc="1" for="btnradio2">Exclude</label> </div> </div>'
        );
}
});
         </script>
   ...
   var filter_name = Array.from(options).map(({ value }) => value);
   var location_inc_exc = $('.location_inc_exc.active').attr('data-location_inc_exc');
      ...
      location.reload();
        ...
        $.ajax({
            ...
            data: {
                ...
                location_inc_exc: location_inc_exc
            },
            beforeSend: function() {
                $('.show_filter_company_list_msg').show();
            },
      ...
      let a = $(this).data('select2');
        if ($('.include-btn').length == 0) {
        $(".select2-results:not(:has(a))").append('<div class="include-btn"> <div class="btn-group" role="group" aria-label="Basic radio toggle button group"> <label class="btn btn-outline-primary active location_inc_exc" data-location_inc_exc="0" for="btnradio1">Include</label> <label class="btn btn-outline-primary location_inc_exc" data-location_inc_exc="1" for="btnradio2">Exclude</label> </div> </div>');
}
});
    ...
    var filter_name = Array.from(options).map(({ value }) => value);
     var industry_inc_exc = $('.industry_inc_exc.active').attr('data-industry_inc_exc');
        if(filter_name == ""){
      ...
      location.reload();
        ...
        $.ajax({
            ...
            data: {
                ...
                name:"Industry",
                industry_inc_exc:industry_inc_exc
            },
            beforeSend: function() {
                $('.show_filter_company_list_msg').show();
            },
      ...
      let a = $(this).data('select2');
        if ($('.include-btn').length == 0) {
        $(".select2-results:not(:has(a))").append('<div class="include-btn"> <div class="btn-group" role="group" aria-label="Basic radio toggle button group"> <label class="btn btn-outline-primary active industry_inc_exc" data-industry_inc_exc="0" for="btnradio1">Include</label> <label class="btn btn-outline-primary industry_inc_exc" data-industry_inc_exc="1" for="btnradio2">Exclude</label> </div> </div>');
}
});
   ...
   var filter_name = Array.from(options).map(({ value }) => value);
    ...
    <script>
        ...
        var filter_name = Array.from(options).map(({ value }) => value);
        var job_inc_exc = $('.job_inc_exc.active').attr('data-job_inc_exc');
      ...
      let a = $(this).data('select2');
        if ($('.include-btn').length == 0) {
        $(".select2-results:not(:has(a))").append('<div class="include-btn"> <div class="btn-group" role="group" aria-label="Basic radio toggle button group"> <label class="btn btn-outline-primary active job_inc_exc" data-job_inc_exc="0" for="btnradio1">Include</label> <label class="btn btn-outline-primary job_inc_exc" data-job_inc_exc="1" for="btnradio2">Exclude</label> </div> </div>');
}
});
