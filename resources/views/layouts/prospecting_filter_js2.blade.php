 <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  ...
  // $(this).find(':selected').data('data-select2-id',"1");
      ...
      let a = $(this).data('select2');
        ...
        $(".select2-results:not(:has(a))").append('<div class="include-btn"> <div class="btn-group"> <a class="btn btn-outline-primary in-ex-btn">Include</a> <a class="btn btn-outline-primary in-ex-btn">Exclude</a> </div> </div>'
